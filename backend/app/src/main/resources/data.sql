...
INSERT INTO ads (title, description, donor_id, phone, email, address_id, status, created_at, updated_at, conclusion_code, images_path) VALUES
  ...
  ('Pilhas e baterias usadas', 'Pacote com pilhas alcalinas e algumas baterias recarregáveis usadas — armazenadas com segurança.', 6,'21987654321', 'claudia.maria@email.com',  6, 'concluded', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'B6L2R', ARRAY['http://localhost:8081/api/v1/files/as8ds65_pilhas-e-baterias.jpg']),
  ('Garrafas PET grandes', 'Garrafas PET (2L) lavadas e secas — lote para reciclagem.', 11, '21987654321', 'yuri.barreto@email.com', 12, 'active', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), NULL, ARRAY['http://localhost:8081/api/v1/files/e43367e_garrafas-pet.jpg']),
  ('Latas amassadas', 'Latas de alumínio limpas e amassadas, prontas para coleta.', 11, '21987654321', 'yuri.barreto@email.com', 12, 'active', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), NULL, ARRAY['http://localhost:8081/api/v1/files/54r30t0_latas.webp']),
