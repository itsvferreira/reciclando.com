import fotoHome from '../../assets/hero/foto-home-1.jpg';
import './Home.css';
import { Recycle, FileText, Package, Wine, Cpu, Battery } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { isComumLoggedIn, isRecicladorLoggedIn } from '../../utils/loggedUsers';
      ...
      <div className='home-page'>
          ...
          <div className='home-container'>
            <div className='home-left'>
              ...
              <p style={{ fontSize: '18px' }}>
                Descarte seus recicláveis de forma consciente e apoie quem
                transforme isso com renda
              </p>
        ...
        <section className='home-materiais-aceitos'>
          ...
          <div className='materiais-cards'>
            ...
            <div className='material-item baterias'>
              <Battery size={32} />
              <span>Baterias</span>
            </div>
          </div>
            ...
            <div className='como-funciona-cards-container'>
              <div className='como-funciona-card'>
                ...
                <div className='card-conteudo'>
                  <h3>Conecte-se</h3>
                  <p>
                    Busque recicladores próximos ou publique seus resíduos para
                    descarte.
                  </p>
                </div>
              </div>
              <div className='como-funciona-card'>
                ...
                <div className='card-conteudo'>
                  <h3>Combine</h3>
                  <p>
                    Converse diretamente por WhatsApp ou ligação e agende o dia
                    e horário da coleta.
                  </p>
                </div>
              </div>
